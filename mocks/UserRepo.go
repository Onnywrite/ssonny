...
func (_m *UserRepo) SaveUser(_a0 context.Context, _a1 models.User) (*models.User, error) {
...
func (_c *UserRepo_SaveUser_Call) Return(_a0 *models.User, _a1 error) *UserRepo_SaveUser_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *UserRepo_SaveUser_Call) RunAndReturn(run func(context.Context, models.User) (*models.User, error)) *UserRepo_SaveUser_Call {
	_c.Call.Return(run)
	return _c
}
