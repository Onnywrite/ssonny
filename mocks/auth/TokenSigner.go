...
// SignEmail provides a mock function with given fields: userId
func (_m *TokenSigner) SignEmail(userId uuid.UUID) (string, error) {
	ret := _m.Called(userId)

	if len(ret) == 0 {
		panic("no return value specified for SignEmail")
	}
...
// TokenSigner_SignEmail_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'SignEmail'
type TokenSigner_SignEmail_Call struct {
	*mock.Call
}

// SignEmail is a helper method to define mock.On call
//   - userId uuid.UUID
func (_e *TokenSigner_Expecter) SignEmail(userId interface{}) *TokenSigner_SignEmail_Call {
	return &TokenSigner_SignEmail_Call{Call: _e.mock.On("SignEmail", userId)}
}

func (_c *TokenSigner_SignEmail_Call) Run(run func(userId uuid.UUID)) *TokenSigner_SignEmail_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *TokenSigner_SignEmail_Call) Return(_a0 string, _a1 error) *TokenSigner_SignEmail_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *TokenSigner_SignEmail_Call) RunAndReturn(run func(uuid.UUID) (string, error)) *TokenSigner_SignEmail_Call {
	_c.Call.Return(run)
	return _c
}
